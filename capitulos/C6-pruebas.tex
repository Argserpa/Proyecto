	...
	rtmp {
		server {
			...
			application live {
				...
				hls_fragment 1s;          # <-- Reducir a 1 segundo
				hls_playlist_length 3s;   # <-- Reducir a 3 segundos
				# hls_sync 1ms;           # <-- Opcional: sincronizacion mas precisa
				
				dash on;
				dash_path /tmp/hls/live;  # O /tmp/dash/live si quieres una ruta separada para DASH
				# dash_fragment 1s;       # Puedes anhadir esto para DASH tambien si no esta ya
				# dash_playlist\_length 3s; # Similar a HLS para DASH
