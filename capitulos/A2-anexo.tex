...
\subsection{VirtualBox Extension Pack}
Hay que tener en cuenta qué versión del VBox tenemos para instalar la extensión para dicha versión. De no hacerlo así no se podrá utilizar. Una vez instalado, se podrá seleccionar la webcam y los USB del host.
...
\begin{figure}[h!]
	\begin{minipage}{0.7\textwidth}
		\centering
		\includegraphics[width=\textwidth]{017OBS Studio stream configuration.png}
		\caption{Configuración OBS stream.}
	\end{minipage}	
	\label{fig:figure001}
\end{figure}
...
\begin{figure}[h!]
	\begin{minipage}{0.7\textwidth}
		\centering
		\includegraphics[width=\textwidth]{018OBS Studio output configuration.png}
		\caption{Configuración OBS Output.}
	\end{minipage}	
	\label{fig:figure001}
\end{figure}
